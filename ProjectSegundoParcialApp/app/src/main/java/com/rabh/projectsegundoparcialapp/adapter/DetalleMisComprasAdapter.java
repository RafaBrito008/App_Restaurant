    ...
    protected class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setItem(final DetallePedido detalle) {
            ...
            picasso.load(url)
                    ...
                    .into(imgProduct);
            txtValueCodDetailPurchases.setText("P00" + Integer.toString(detalle.getPedido().getId()));
            txtValuePlatillo.setText(detalle.getPlatillo().getNombre());
            txtValueQuantity.setText(Integer.toString(detalle.getCantidad()));
            txtValuePrecioPlatillo.setText(String.format(Locale.ENGLISH, "$%.2f", detalle.getPrecio()));
        }
    }
}
